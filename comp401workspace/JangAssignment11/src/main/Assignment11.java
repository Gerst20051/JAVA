...
//
		...
		CommandInterpreter aCommandInterpreter = new ACommandInterpreter(
				ozscene, scanner, broadcastingclearancemanager);
...
//		ThreadSupport.sleep(1000);
		...
		aCommandInterpreter.waitinganimateDoroty();
		aCommandInterpreter.waitinganimateOz();
		aCommandInterpreter.waitinganimateScarecrow();
		aCommandInterpreter.animatestart();
