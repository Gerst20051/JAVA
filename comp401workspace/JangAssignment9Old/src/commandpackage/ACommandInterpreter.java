...
public class ACommandInterpreter implements MouseListener, KeyListener, CommandInterpreter {
	OzScene ozscene;
	AScanner scanner;
	...
	public void keyTyped(KeyEvent e) {
		...
		switch (typedChar) {
		case 'd':
			ozscene.getDorothy().setX(x_point);
			ozscene.getDorothy().setY(y_point);
			break;
		case 's':
			ozscene.getScarecrow().setX(x_point);
			ozscene.getScarecrow().setY(y_point);
			break;
		case 'o':
			ozscene.getOz().setX(x_point);
			ozscene.getOz().setY(y_point);
			break;
		case 'r':
			ozscene.getDorothy();
			ozscene.getOz();
			ozscene.getScarecrow();
			break;
