...
public class APlottedShuttleJPanelAndView1 extends ACartesianPlaneJPanelAndView implements BeanView {   
    ObservablePlottedShuttle plottedShuttle;    
    public APlottedShuttleJPanelAndView1(ObservablePlottedShuttle aPlottedShuttle) {
