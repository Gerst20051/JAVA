...
import mvc.properties.AnObservableBMISpreadsheet;
import mvc.properties.ObservableBMISpreadsheet;
...
public class BMIFrameComposer {
    ...
    public static void composeLabelledField(JPanel aPanel, JLabel aLabel, JTextField aField) {
    ...
    public static void composeMVC() {
        ...
        BeanView bmiSpreadsheetView = new ABMISpreadsheetView(heightField, weightField, bmiSlider, bmiProgressBar);
        bmiSpreadsheetView.register(bmiSpreadsheet);
    }
}