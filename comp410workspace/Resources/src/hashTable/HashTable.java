 ...
 * @date 11.8.2010
 * @param <K>
 *            Any generic type representing the key for the hash table; this
 *            must implement toString() in a unique manner for unique keys
 * @param <V>
 *            Any generic type representing the values for the hash table
 */
public class HashTable<K, V> {
	 ...
	 * 
	 * @return The number of maximum number of probes that were necessary in the
	 *         most recent find() call
	 */
	 ...
	 * 
	 * @param key
	 *            The key to find the value(s) for
	 ...
	 * 
	 * @param key
	 *            The key value corresponding to the records that we want to
	 *            delete
	 ...
	 * 
	 * @pre The key must implement the toString() method in a way such that it
	 *      returns distinct strings for distinct keys
